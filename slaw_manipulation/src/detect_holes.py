...
def j48(features):
    ...
    if axis2 <= 65.030762:
        if axis1 <= 46.270941:
            if axis2 <= 43.416587:
                if intensity <= 36.302977:
                    return "M20"
                if intensity > 36.302977:
                    if axis1 <= 36:
                        if intensity <= 36.786942:
                            return "M30"
                        if intensity > 36.786942:
                            if area <= 1196:
                                return "M20"
...
#        self.detector  = cv2.FastFeatureDetector(16, True) #cv2.SURF()
        ...
        self.pose_pub = rospy.Publisher("/vision/detected_hole", PoseStampedLabeled)
    ...
    def filter_contours(self, contours):
        ...
        done = True#False#False #HENNES: True = no merge
        #print conts
        #print len(contours)
        #print len(conts)
