...
def callback(pose):
	...
	print ("pose1", pose.pose.position.x, pose.pose.position.y, pose.pose.position.z, pose.pose.orientation.x, pose.pose.orientation.y, pose.pose.orientation.z,pose.pose.orientation.w)  
	...
	# pose2 = iks.create_pose(x, y, z, roll, pitch, yaw)

	# pose.pose.orientation=pose2.pose.orientation

	

	# print ("pose2", pose2.pose.position.x, pose2.pose.position.y, pose2.pose.position.z, pose2.pose.orientation.x, pose2.pose.orientation.y, pose2.pose.orientation.z,pose2.pose.orientation.w)  
...
if __name__ == "__main__":
	...
	rospy.Subscriber("/arm_pose_in", PoseStamped, callback)
	rospy.spin()
