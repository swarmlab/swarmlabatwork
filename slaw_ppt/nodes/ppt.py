...
def ppt():
    ...
    with sm:
        ...
        smach.StateMachine.add("ScanHole", ScanForHoles(), transitions = {'success': 'FinePlace', 'failed':'ScanMatcherPrePlace','nothing_found': 'ScanMatcherPrePlace'}, remapping = {'pose_in':'pose', 'pose_out':'pose', 'object_in':'object', 'object_out':'object', 'point_out':'point'})

                               
        smach.StateMachine.add('FinePlace', FinePlace(), transitions = {'success':'RecoverToStart', 'failed':'TuckArmFailPlace', 'too_far':'ScanMatcherPrePlace','failed_after_place':'TuckArmFailPlace'}, remapping = {'object_in':'object','pose_in':'pose', 'pose_out':'pose', 'point_in':'point'})
